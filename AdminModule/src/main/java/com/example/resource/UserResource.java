...
public class UserResource {
	...
	public ResponseEntity<CommonApiResponse> registerAdmin(RegisterUserRequestDto dto) {
	    ...
	    List<User> usersWithEmail = us.findbyemail(dto.getEmailId());
	    ...
	    List<User> usersWithFullName = us.findbyfirstnameAndlastname(dto.getFirstName(), dto.getLastName());
	    ...
	    List<User> findbyphoneNo = us.findbyphoneNo(dto.getPhoneNo());
...
Address add=new Address();
	    ...
	    User user = RegisterUserRequestDto.toUserEntity(dto);
	    if (user == null) {
