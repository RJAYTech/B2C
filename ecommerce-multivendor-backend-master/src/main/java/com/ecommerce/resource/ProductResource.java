...
public class ProductResource {
	...
	public ResponseEntity<CommonApiResponse> addProduct(ProductAddRequest productDto) {
		...
		byte[] productImageName1 = storageService.store(productDto.getImage1());
		byte[] productImageName2 = storageService.store(productDto.getImage2());
		byte[] productImageName3 = storageService.store(productDto.getImage3());
	...
	public ResponseEntity<CommonApiResponse> updateProductImage(ProductAddRequest request) {
		...
		byte[] existingImage1 = product.getImage1();
		byte[] existingImage2 = product.getImage2();
		byte[] existingImage3 = product.getImage3();

		// store updated product image in Image Folder and give name to store in
		// database
		byte[] productImageName1 = storageService.store(request.getImage1());
		byte[] productImageName2 = storageService.store(request.getImage2());
		byte[] productImageName3 = storageService.store(request.getImage3());
